...
const pkmkIdsBy3 = pokémon.filter( p => p.id % 3 === 0)
console.log(pkmkIdsBy3);

// an array of pokémon objects that are "fire" type
const pkmktype = pokémon.filter( p => p.types[0] === "fire")
console.log(pkmktype);

// an array of pokémon objects that have more than one type
const pkmkMoreThan1 = pokémon.filter( p => p.types[1])
